...
const apiKey = "2a815c25d9bbff7220924ee36fa3ed8a"
...
async function checkWeather(city) {
    ...
    const apiWeatherUrlWithParams = `${apiURL}?q=${city}&appid=${apiKey}&units=metric`
    ...
    if (response.status == '404') {
        ...
        const data = await response.json()
            ...
            let imagesWeather = document.querySelector('.weather-icons')
